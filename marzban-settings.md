...
Для доступа к дашборду панели по защищенному протоколу https нам нужно подключить домен или поддомен и создать ssl сертификат. Бесплатный поддомен можно получить на сервисе DuckDNS([ссылка](https://www.duckdns.org/)).

.... сюда скриншот с дак днс ......

Здесь вставляете любой слово или рандомный набор латинских букв, вообще не важно какой, жмете add domain. После этого для вас будет создан поддомен вида youword.duckdns.org, где "youword" - то слово или те буквы, которые вы ввели.

...... сюда еще один скриншот с дак днс .......
    ...
    },
    {
      ...
      "streamSettings": {
        ...
        "realitySettings": {
          ...
          "privateKey": "aO1tE699SJ3eLQvybE0AAsx_XAlTwZesDnCZ6mhNMnw",
          "shortIds": [
            "0458ab6a9a7e6207"
          ]
        }
